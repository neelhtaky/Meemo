...
if ( ( 0 < $previous_lesson_id ) || ( 0 < $next_lesson_id ) ) { ?>
	<nav id="post-entries" class="fix row">
        ...
        <?php if ( 0 < $next_lesson_id ) { ?><div class="nav-next fr small-12 medium-12 large-12 xlarge-6 xx-large-6 columns"><a href="<?php echo esc_url( get_permalink( $next_lesson_id ) ); ?>" rel="prev" class="button"><span class="meta-nav"></span> <?php echo get_the_title( $next_lesson_id ); ?></a></div><?php } ?>
    </nav><!-- #post-entries -->
<?php } ?>