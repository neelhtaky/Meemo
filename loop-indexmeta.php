				...
				<footer class="byline meta postmetadata">
					...
					<div class="author">Written by <?php the_author(); ?>.</div>
						...
						<?php if (get_comments_number()==0) {
							    ...
							    <a href="<?php comments_link(); ?>" class="comments-link"><?php comments_number( 'No Responses Yet. Leave a response?','1 Response.', '% Responses.', 'comments-link', 'Sorry, Comments are closed.'); ?></a>
							<?php } ?>
